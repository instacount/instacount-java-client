...
public class GetShardedCounterResponse extends InstacountResponse
{
	@NonNull
	 ...
	 */
	public GetShardedCounterResponse(final Response response, final Quota quota, final ShardedCounter shardedCounter)
	{
